        ...
        <div className="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
          ...
          <div className="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
            ...
            <p className="block max-w-2xl mt-4 text-gray-500 dark:text-gray-300">
              Dive into the Possibilities of Personalization with Our Transport
              App. Create Your Perfect Route with State-of-the-Art Technology
              and Seamless Integration. Empower Your Journey and Maximize
